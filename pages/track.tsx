...
const Track = () => {
  ...
  return (
    <div className={"w-[100%] h-full"}>
      <div className="flex flex-col w-[500px] gap-2 mb-[-80px]">
        <button
      ...
      <div className="relative h-full mx-[200px]">
        ...
        >
          <div className="absolute top-[100px] left-[300px] w-2 min-h-[300px] h-[560px] bg-red-track"></div>
        ...
        >
          <div className="absolute top-0 left-[350px] w-2 min-h-[300px] h-[630px] bg-green-track"></div>
          <div className="absolute top-[630px] left-[350px] origin-top-left -rotate-45 w-2 h-[150px] bg-green-track"></div>
          <div className="absolute top-[731px] left-[454px] w-2 h-[130px] bg-green-track"></div>
          <div className="absolute left-[344px] flex flex-col gap-1">
        ...
        >
          <div className="absolute top-[30px] right-[150px] w-2 min-h-[300px] h-[600px] bg-blue-track"></div>
          <div className="absolute top-[630px] right-[150px] origin-top-right rotate-45 w-2 h-[150px] bg-blue-track"></div>
          <div className="absolute top-[731px] right-[254px] w-2 h-[130px] bg-blue-track"></div>
          <div className="absolute w-[266px] right-[136px] flex flex-col gap-1">
        ...
        >
          <div className="absolute top-[100px] right-[100px] w-2 min-h-[300px] h-[560px] bg-orange-track"></div>
          <div className="absolute top-[660px] right-[100px] origin-top-right rotate-45 w-2 h-[150px] bg-orange-track"></div>
          <div className="absolute top-[761px] right-[204px] w-2 h-[100px] bg-orange-track"></div>
          <div className="absolute top-[90px] w-[236px] -right-[122px] flex flex-col gap-1">
