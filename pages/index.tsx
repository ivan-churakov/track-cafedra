    ...
    <div className={"relative w-[100%] h-full"}>
      ...
      <div className="flex flex-col h-full justify-between items-center gap-10 p-4 sm:p-6">
        <div className="grid grid-cols-3 gap-8">
          ...
          <div onClick={() => setShow2(true)} className="flex flex-col bg-white shadow-2xl rounded-xl p-4">
            <p className="font-medium text-center text-xl">
        ...
        <div className="grid grid-cols-3 gap-8">
          ...
          <div onClick={() => setShow3(true)} className="flex flex-col max-h-[367px] bg-white shadow-2xl rounded-xl p-4">
            <p className="font-medium text-center text-xl">
